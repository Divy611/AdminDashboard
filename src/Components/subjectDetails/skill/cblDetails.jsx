...
export default function CBLDetails() {
  ...
  return (
    <div className='p-5'>
      <button className="flex items-center" onClick={handleButtonClick}>
        ...
        <h1 className='text-3xl text-black font-semibold ml-2'>Corporate and Business Law</h1>
        <div className="px-3">
      ...
      <DetailsTable headers={headers} subject={"Corporate and Business Law"}/>
    </div>
  )
}
