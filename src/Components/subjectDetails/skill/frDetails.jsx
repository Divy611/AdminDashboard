...
export default function FRDetails() {
  ...
  return (
    <div className='p-5'>
      <button className="flex items-center" onClick={handleButtonClick}>
          ...
          <h1 className='text-3xl text-black font-semibold ml-2'>Financial Reporting</h1>
        <div className="px-3">
      ...
      <DetailsTable headers={headers} subject={"Financial Reporting"}/>
    </div>
  )
}
