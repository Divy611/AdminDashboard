...
export default function AADetails() {
  ...
  return (
    <div className='p-5'>
      <button className="flex items-center" onClick={handleButtonClick}>
        ...
        <h1 className='text-3xl text-black font-semibold ml-2'>Audit and Assurance</h1>
        <div className="px-3">
          <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60">
            <span class="h-1.5 w-1.5 rounded-full bg-emerald-500"></span>
            <h2 class="text-sm font-normal text-emerald-500">7 Confirmed</h2>
          </div></div>
        <div className="px-3">
          <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-red-100">
            <span class="h-1.5 w-1.5 rounded-full bg-red-500"></span>
            <h2 class="text-sm font-normal text-red-500">2 Cancelled</h2>
          </div></div>
        <div className="px-3">
          <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-yellow-100">
            <span class="h-1.5 w-1.5 rounded-full bg-yellow-500"></span>
            <h2 class="text-sm font-normal text-yellow-500">1 Refunded</h2>
          </div>
        </div>
      </button>
      <DetailsTable headers={headers} subject={"Audit and Assurance"} />
    </div>
  )
}
