...
export default function BTDetails() {
  ...
  return (
    <div className='p-5'>
      <button className="flex items-center" onClick={handleButtonClick}>
        ...
        <h1 className='text-3xl text-black font-semibold ml-2'>Business and Technology</h1>
        <div className="px-3">
      ...
      <DetailsTable headers={headers} subject={"Business and Technology"} />
    </div>
  )
}
