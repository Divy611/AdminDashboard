...
export default function AAADetails() {
  ...
  return (
    <div className='p-5'>
      <button className="flex items-center" onClick={handleButtonClick}>
        ...
        <h1 className='text-3xl text-black font-semibold ml-2'>Advanced Audit and Assurance</h1>
        <div className="px-3">
      ...
      <DetailsTable headers={headers} subject={"Advanced Audit and Assurance"} />
    </div>
  )
}
